...
class FlutterFlowMarker {
  ...
  final latlng.LatLngFF location;
...
class FlutterFlowGoogleMap extends StatefulWidget {
  ...
  final Function(latlng.LatLngFF)? onCameraIdle;
  final latlng.LatLngFF? initialLocation;
...
extension ToGoogleMapsLatLng on latlng.LatLngFF {
  LatLng toGoogleMaps() => LatLng(latitude, longitude);
}

extension GoogleMapsToLatLng on LatLng {
  latlng.LatLngFF toLatLng() => latlng.LatLngFF(latitude, longitude);
}
