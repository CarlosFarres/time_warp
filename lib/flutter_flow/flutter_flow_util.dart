...
import 'lat_lngFF.dart';

export 'lat_lngFF.dart';
export 'place.dart';
...
LatLngFF? cachedUserLocation;
Future<LatLngFF> getCurrentUserLocation(
    {required LatLngFF defaultLocation, bool cached = false}) async {
...
Future<LatLngFF?> queryCurrentUserLocation() async {
  ...
  return position.latitude != 0 && position.longitude != 0
      ? LatLngFF(position.latitude, position.longitude)
      : null;
}
