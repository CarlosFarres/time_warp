...
class TimeWarpSupabaseUser extends BaseAuthUser {
  TimeWarpSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> timeWarpSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = TimeWarpSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
